class Talking extends Phaser.Scene {
    ...
    create() {
        ...
        this.spongbob = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'spongbob').setOrigin(0, 1)
        this.sadspong = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'sadspongbob').setOrigin(0, 1).setScale(.2)
